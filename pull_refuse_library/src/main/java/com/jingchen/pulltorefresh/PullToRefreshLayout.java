...
import static com.jingchen.pulltorefresh.R.id.state_iv;
...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public void setCustomRefreshView(View v) {
        ...
        customRefreshView.setLayoutParams(lp);
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        Log.e("PullToRefreshLayout", "pullUpY = " + pullUpY);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.e("PullToRefreshLayout", "pullableView.height = " + pullableView.getHeight() + "  pullableView.getY() = " + pullableView.getY());
    ...
    private void initView() {
        ...
        if (null == customRefreshView) {
            ...
            refreshStateImageView = defaultRefreshView.findViewById(state_iv);
        }
        // 初始化上拉布局
        if (null == customLoadmoreView) {
    ...
    public interface OnPullListener {
         ...
         * 加载操作
         */
        void onCancel(PullToRefreshLayout pullToRefreshLayout);
    }
